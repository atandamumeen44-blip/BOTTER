...
pub fn known_dexes() -> Vec<DexDef> {
    vec![
        DexDef {
            name: "quickswap",
            factory: addr("0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff"), // Amoy Quickswap router (also factory)
...
pub fn token_pairs() -> Vec<TokenPairDef> {
    ...
    if chain_id == 80002 {
        // Amoy testnet – use USDC and WMATIC
        vec![
            TokenPairDef {
        ...
        // Polygon mainnet – use USDC and WETH
        vec![
            TokenPairDef {
